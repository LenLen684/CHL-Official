...
// VALORANT
{
    ...
    // LAST CHARACTER PLAYED & STATS
    app.get('/saved/valorant/last-character-played/:name/:tag', (req, res) => val.getLastCharacterPlayed(req, res));
    ...
    app.get('/valorant/game/:id', (req, res) => val.getMatchByGameID(req, res));
